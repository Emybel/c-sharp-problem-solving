...
namespace MyApp
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Challenge1.SumAndTriple();
            // Challenge2.AbsDiff();
            // Console.Write(Challenge3.CheckFor30());
            // Console.Write(Challenge4.Whithin10());
            // Console.Write(Challenge5.StartWithIf());
            // Console.Write(Challenge6.RemoveNthChar(3));
            // Console.Write(Challenge7.ReplaceFirtWithLast());
